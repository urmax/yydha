import{_ as n,o as s,c as a,e as t}from"./app-e8aaed08.js";const p={},e=t(`<h2 id="需求" tabindex="-1"><a class="header-anchor" href="#需求" aria-hidden="true">#</a> 需求</h2><p>elementUi的table需要自定义表头，点击表头需要有click事件。</p><h2 id="直接上代码" tabindex="-1"><a class="header-anchor" href="#直接上代码" aria-hidden="true">#</a> 直接上代码</h2><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>el-table</span>
