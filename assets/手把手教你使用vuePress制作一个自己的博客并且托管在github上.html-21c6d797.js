...
cd -
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-3-执行脚本" tabindex="-1"><a class="header-anchor" href="#_2-3-执行脚本" aria-hidden="true">#</a> 2.3 执行脚本</h2><p>然后命令行切换到 <code>vuepress-starter</code> 目录下，执行 <code>sh deploy.sh</code>，就会开始构建，然后提交到远程仓库，注意这里提交到了 <code>gh-pages</code> 分支。</p><h2 id="_2-4-地址查看" tabindex="-1"><a class="header-anchor" href="#_2-4-地址查看" aria-hidden="true">#</a> 2.4 地址查看</h2><p><code>github</code> 仓库的 <code>Settings -&gt; Pages</code> 中看到地址。</p>`,42);function b(p,h){const d=c("ExternalLinkIcon");return s(),a("div",null,[e("h1",v,[u,i(" 1. "),e("a",o,[i("VuePress"),l(d)])]),m])}const _=n(t,[["render",b],["__file","手把手教你使用vuePress制作一个自己的博客并且托管在github上.html.vue"]]);export{_ as default};
