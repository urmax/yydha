import{_ as e}from"./framework-c27b6911.js";import{o as a,c as r,d}from"./app-a02037cf.js";const t="/yydha/assets/2023-01-13_1-d7859aa0.png",i="/yydha/assets/2023-01-13_2-90f3eb1f.png",s="/yydha/assets/2023-01-13_3-383ebeae.png",n="/yydha/assets/2023-01-13_4-9a18b273.png",c="/yydha/assets/2023-01-13_5-2e8d5b46.png",l="/yydha/assets/2023-01-13_6-0b91ec73.png",o="/yydha/assets/2023-01-13_7-ed157013.png",h="/yydha/assets/2023-01-13_8-e21b759f.png",p="/yydha/assets/2023-01-13_9-c9089f19.png",b="/yydha/assets/2023-01-13_10-80010b3e.png",_="/yydha/assets/2023-01-13_11-386287df.png",u={},m=d(`<h1 id="css-backdrop-filter简介-毛玻璃、磨砂效果" tabindex="-1"><a class="header-anchor" href="#css-backdrop-filter简介-毛玻璃、磨砂效果" aria-hidden="true">#</a> CSS backdrop-filter简介：毛玻璃、磨砂效果</h1><p>前两天在实现设计稿的时候，发现有个磨砂的效果，网上搜索了下使用到了这个css，赶完工以后回过头来，看下这个东西，浅浅的记录一下用法。</p><h2 id="在mdn上可以看到详细的介绍" tabindex="-1"><a class="header-anchor" href="#在mdn上可以看到详细的介绍" aria-hidden="true">#</a> 在mdn上可以看到详细的介绍</h2><p>可以让你为一个元素后面区域添加图形效果（如模糊或颜色偏移）。因为它适用于元素背后的所有元素，为了看到效果，必须使元素或其背景至少部分透明。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>/* 关键词值 */
...
</code></pre><h3 id="_7-hue-rotate-色调变化" tabindex="-1"><a class="header-anchor" href="#_7-hue-rotate-色调变化" aria-hidden="true">#</a> 7. hue-rotate 色调变化</h3><p><img src="`+o+'" alt="图例"></p><h3 id="_8-invert-反向" tabindex="-1"><a class="header-anchor" href="#_8-invert-反向" aria-hidden="true">#</a> 8. invert 反向</h3><p><img src="'+h+'" alt="图例"></p><h3 id="_9-opacity-透明度" tabindex="-1"><a class="header-anchor" href="#_9-opacity-透明度" aria-hidden="true">#</a> 9. opacity 透明度</h3><p><img src="'+p+'" alt="图例"></p><h3 id="_10-sepia-饱和度" tabindex="-1"><a class="header-anchor" href="#_10-sepia-饱和度" aria-hidden="true">#</a> 10. sepia 饱和度</h3><p><img src="'+b+'" alt="图例"></p><h3 id="_11-saturate-褐色" tabindex="-1"><a class="header-anchor" href="#_11-saturate-褐色" aria-hidden="true">#</a> 11. saturate 褐色</h3><p><img src="'+_+'" alt="图例"></p><h2 id="完整demo可以点击下面链接打开-打开调试工具更改样式。" tabindex="-1"><a class="header-anchor" href="#完整demo可以点击下面链接打开-打开调试工具更改样式。" aria-hidden="true">#</a> 完整demo可以点击下面链接打开, 打开调试工具更改样式。</h2><p>[点我查看CSS backdrop-filter简介：毛玻璃、磨砂效果例子](https://yydha.gitee.io/html-demo/html/CSS backdrop-filter简介：毛玻璃、磨砂效果.html)</p>',37),f=[m];function v(g,k){return a(),r("div",null,f)}const S=e(u,[["render",v],["__file","CSS backdrop-filter简介：毛玻璃、磨砂效果.html.vue"]]);export{S as default};
